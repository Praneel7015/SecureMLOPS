...
def analyze():
    ...
    # ────────────────────────────────────────────────────────────────────────
    # ── ACCESS ANALYSIS (inserted BEFORE ML inference) ───────────────────────
    # ────────────────────────────────────────────────────────────────────────
    ...
    result.update(
        ...
        detection=detection,
        # ── Include access analysis in result for UI / audit ──────────────
        access_analysis=access_result,
    )
    _finalise(result)
    log_security_event(username, result)
...
def _build_pipeline(result: dict) -> list:
    ...
    # Step order now includes "access" between integrity and predict
    ...
    steps = [
        ...
        {
            "id": "predict", "number": "7", "title": "AI Prediction", "label": "Model Inference",
        ...
        {
            "id": "anomaly", "number": "8", "title": "Anomaly Detection", "label": "Statistical Check",
        ...
        {
            "id": "adversarial", "number": "9", "title": "Adversarial Detection", "label": "Attack Probe",
